...
export default function AdmisionesPage() {
  ...
  return (
    <ModulePageLayout
      ...
      title="Control de dictámenes en admisiones"
      description="Consulta transversal de docentes, filtros por médico y acceso operativo para impresión o reapertura cuando aplique."
      compactHero
      actions={
        canExportDictamen ? (
